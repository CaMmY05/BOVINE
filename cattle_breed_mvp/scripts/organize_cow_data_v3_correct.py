"""
Correctly organize 5 cow breeds from Roboflow dataset for V3 model
"""
...
def organize_cow_data_v3():
    ...
    # Based on train folder counts: Sahiwal (313), Gir (239), Holstein_Friesian (222), Jersey (140), Red_Sindhi (109)
    cow_breeds = {
        "sahiwal": "Sahiwal",
        "gir": "Gir", 
    ...
    for split in ["train", "valid", "test"]:
        ...
        for breed_key, breed_name in cow_breeds.items():
            ...
            breed_target = split_target / breed_name
